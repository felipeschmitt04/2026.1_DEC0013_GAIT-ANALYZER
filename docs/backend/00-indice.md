...
1. [Visão geral](01-visao-geral.md)
   Contexto acadêmico, objetivo do backend e limites de responsabilidade.

2. [Arquitetura](02-arquitetura.md)
   Fluxo entre frontend, backend, fila, DGX, storage e contrato de resultado.

3. [Decisões de inferência e DGX](16-decisoes-inferencia-dgx.md)
   Decisões tomadas sobre fila, DGX, cache, escopo e responsabilidades.

4. [Contrato da API](10-api.md)
   Endpoints, payloads, `ResultV1`, `model3d`, `fitting`, artefatos e PDF.

5. [Configuração do ambiente](06-configuracao-ambiente.md)
   Variáveis de ambiente, diretórios, modos de engine e dependências.

6. [Execução sem Docker](07-execucao-sem-docker.md)
   Como rodar a API e o worker DGX direto pelo terminal.

7. [Docker CPU](08-docker.md)
   Build e execução do backend em contêiner leve.

8. [DGX UFSC](11-dgx-ufsc.md)
...
10. [Criação da VM na Azure](03-criacao-vm-azure.md)
    Passo a passo para criar uma VM usando os créditos acadêmicos.

11. [Conexão via SSH](04-conexao-ssh.md)
    Acesso à VM, chaves SSH, portas e comandos úteis de diagnóstico.

12. [GitHub, SSH e Deploy Key](05-github-ssh-deploy-key.md)
...
14. [Testes](15-testes.md)
    Cobertura existente e comandos de validação.

15. [Troubleshooting](13-troubleshooting.md)
    Erros comuns e caminhos rápidos de diagnóstico.

16. [Evidências do Sprint 2](14-evidencias-sprint2.md)
